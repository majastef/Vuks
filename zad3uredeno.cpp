...
int main()
{
	...
	while (strcmp(opcija, "h") != 0)
	{
		...
		else if ((strcmp(opcija, "a") != 0) & (strcmp(opcija, "b") != 0) & (strcmp(opcija, "c") != 0) & (strcmp(opcija, "d") != 0) & (strcmp(opcija, "e") != 0) & (strcmp(opcija, "f") != 0) & (strcmp(opcija, "g") != 0))
